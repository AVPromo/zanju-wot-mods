...
The user config (config.py) lives under a shared AppData parent so the modpack never
wipes it on reinstall:

    %APPDATA%/zanju_wot_mods_cache/premium-time/config.json
"""
...
# this mod's files separate from any other mod that reuses the same parent.
