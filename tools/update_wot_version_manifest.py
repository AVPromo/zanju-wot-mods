"""Refresh the tracked WoT client version manifest from an installed game or explicit version."""
...
def parse_args(argv):
    ...
    parser.add_argument(
        "--dry-run",
        action="store_true",
        help="Show what would change without writing the manifest file.",
    )
    parser.add_argument(
        "--verbose",
        action="store_true",
